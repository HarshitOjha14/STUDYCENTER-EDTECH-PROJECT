    ...
    <div className="bg-richblack-800">
      <div className="flex flex-col lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[100%] lg:w-[30%] flex flex-col gap-3 mb-7 lg:pl-0">
            ...
            <div className="w-[100%] lg:w-[30%] mb-7 lg:pl-0">
          ...
          <div className="lg:w-[50%] flex flex-wrap justify-between pl-3 lg:pl-5 gap-3">
            {FooterLink2.map((ele, i) => (
              <div key={i} className="w-[100%] lg:w-[30%] mb-7 lg:pl-0">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        ...
        <div className="flex flex-col lg:flex-row justify-between w-full gap-3">
          ...
          <div className="text-center mt-5 lg:mt-0">Made with HARSHIT OJHA © 2023 EDUECENTER</div>
        </div>
      </div>
    </div>
  );

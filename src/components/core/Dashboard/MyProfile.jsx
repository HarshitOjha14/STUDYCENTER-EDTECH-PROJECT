...
export default function MyProfile() {
  ...
  My Profile
      ...
      {/* About Section */}
      <div className="my-10 flex flex-col gap-y-4 rounded-md border border-richblack-700 bg-richblack-800 p-6 sm:p-8">
      ...
      <div className="my-10 flex flex-col gap-y-6 rounded-md border border-richblack-700 bg-richblack-800 p-6 sm:p-8">
        ...
        <div className="flex flex-col md:flex-row gap-y-6 gap-x-10 max-w-[600px]">
          {/* Column 1 */}
